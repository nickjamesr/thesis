...
\begin{figure}[t]
  ...
  and the fidelities (Kolmogorov distance between normalised probability
  distribution functions) of individual distributions are (a) \(0.97\); (b)
  \(0.94\); (c) \(0.99\); (d) \(0.89\).}
...
\end{equation}
and unitary matrices are compared using the trace distance
\begin{equation}
  \frac{1}{2} \abs{ \Tr \of{ \mat{U}^{\dagger} \mat{U}^{\prime} } }
\end{equation}
