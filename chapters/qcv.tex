...
not an issue in integrated optics \todo{citation needed}.
...
quantum computing) \todo{citation. Hifi?} or fully evaluating the output
probability distribution (for \bosonsampling{}) \todo{citation. Any of the BS
experiments?}. However, as the size of devices---and more importantly the number
