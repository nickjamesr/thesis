...
Anthony Laing. The physical platform used in this simulation was a bulk optics
circuit built by Enrique, which I calibrated. The experiment was planned by
Enrique and data was collected by me and Chris Sparrow. I performed the data
analysis.
...
\cite{pt-prep} with co-authors Yogesh Jonglekar, Chris Sparrow, Chris Harrold,
...
\section{Conclusions}
\todo{Expand this section. Discussion should concern the following points: 
(Molecules: real, physical system of interest. Cite Harvard.)
(Scaling: going from bulk to integrated. Bigger system implies more modes - easy
in integrated optics.)
(PT: ``fully quantum'' unlike previous experiments. Demonstration of general
method for non-Hermitian dynamics)}

We have therefore demonstrated the ability to simulate the evolution of a 2-site
