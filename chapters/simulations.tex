...
\begin{figure}[t]
  ...
  \begin{subfigure}{0.49\textwidth}
    \includegraphics[width=\textwidth]{figures/protected/manifold_A}
    \caption{}
  \end{subfigure}
  \begin{subfigure}{0.49\textwidth}
    \includegraphics[width=\textwidth]{figures/protected/manifold_raw_A}
    \caption{}
  \end{subfigure}
...
evolution of the \(\pt{}\)-symmetric system, or by considering detection events
on any other modes, we can study the interaction between the system and the
