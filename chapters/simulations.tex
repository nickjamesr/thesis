...
time-reversal \((\op{T})\) operations. The theory of the 2-site
\(\pt\)-symmetric model was developed by Yogesh Jonglekar. I derived the
matrices to be simulated, and performed the data analysis. The data was
collected jointly by me and Chris Sparrow.
...
Zehnder interferometers (MZIs) to achieve the necessary reconfigurability. Full
simulations of the time evolution are performed for two regions of the phase
space: one below and one above the \(\pt\) threshold. The results of the
