...
\begin{abstract}
Quantum technologies have the potential to impact on every aspect of our lives.
As we become more dependent on cryptography, the possibility of a quantum
computer breaking our classical codes has profound implications. Perhaps
...
technologies such as quantum key distribution (QKD) and quantum random number
generation (qRNG) are already making their way out of the lab and being pursued
...
could provide a theoretically-grounded example of quantum superiority, while
